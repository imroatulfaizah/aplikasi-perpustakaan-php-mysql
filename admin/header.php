...
<head>
	...
	include 'config.php';
	?>
	<title>PERPUSTAKAAN Mts Al-Manar</title>
...
<body>
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="http://www.unikama.ac.id" class="navbar-brand">PERPUSTAKAAN Mts Al-Manar</a>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="mahasiswa.php"><span class="glyphicon glyphicon-briefcase"></span>  Entry Anggota</a></li>	
